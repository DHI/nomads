...
import * as stories from './Internationalizer.stories';

import { States } from './States';
import { Actions } from './Actions';

<Meta title="Components/Shell" component={Shell} />
...
# [See example in CodeSandbox](https://codesandbox.io/s/shell-intl-6i4x0)

<Preview withToolbar>
  <Story name="Internationalizer">{stories.Internationalizer()}</Story>
</Preview>
