...
declare module '@deck.gl/layers/icon-layer/icon-layer' {
  ...
  export default class IconLayer<D> extends Layer<D> {
    ...
    getShaders(): any;
    initializeState(): void;
    updateState({ oldProps, props, changeFlags }: { oldProps: any; props: any; changeFlags: any }): void;
    finalizeState(): void;
    draw({ uniforms }: { uniforms: any }): void;
    _getModel(gl: any): any;
    _onUpdate(): void;
...
declare module '@deck.gl/layers/solid-polygon-layer/solid-polygon-layer' {
  ...
  export default class SolidPolygonLayer<D> extends Layer<D> {
    ...
    updateGeometry({ props, oldProps, changeFlags }: { props: any; oldProps: any; changeFlags: any }): void;
    _getModels(
      gl: any,
    ): {
      models: any[];
...
declare module '@deck.gl/layers/text-layer/text-layer' {
  ...
  export default class TextLayer<D> extends CompositeLayer<D> {
    ...
    updateState({ props, oldProps, changeFlags }: { props: any; oldProps: any; changeFlags: any }): void;
    finalizeState(): void;
    updateFontAtlas({ oldProps, props }: { oldProps: any; props: any }): void;
